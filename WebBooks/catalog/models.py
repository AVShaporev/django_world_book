...
class Book(models.Model):
    ...
    isbn = models.CharField(max_length=13,
                            help_text="Должно сожержать 13 символов",
...
class BookInstance(models.Model):
    ...
    inv_nom = models.CharField(max_length=20, null=True,
                               help_text="Введите инвентраный номер экзепляра",
                               verbose_name="Инвентарный номер")
    imprint = models.CharField(max_length=200,
                               help_text="Введите издательство и год выпуска",
                               verbose_name="Издательство")
    status = models.ForeignKey('Status', on_delete=models.CASCADE,
                               null=True, help_text="Изменить состояние экзепляра",
                               verbose_name="Статус экзекпляра книги")
    ...
    def __str__(self):
        return f'{self.book} {self.status} №{self.inv_nom}'
